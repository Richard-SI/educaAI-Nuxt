...
declare module "nitropack/types" {
  ...
  interface InternalApi {
    ...
    '/api/ollama': {
      'post': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/ollama.post').default>>>>
    }
    '/api/topics/:id': {
      'default': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/topics/[id]').default>>>>
    }
    '/api/topics': {
      'post': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/topics/index.post').default>>>>
      'default': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/topics/index').default>>>>
    }
    '/__nuxt_error': {
